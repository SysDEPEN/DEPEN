...
export default function StatusProtocol() {
  const steps: stepsProps[] = [
    { id: 1, name: "Envio de documentos", status: "complete", bg: "bg-yellow-300" },
    ...
    <section className="bg-white min-h-screen flex flex-col justify-between">
      ...
      <main className="flex justify-center items-center flex-grow">
        ...
        ">
          {/* Título */}
          <div className="my-6">
            <h2 className="text-xl font-bold my-6">Requerimento de visitação N° 123</h2>
            <p>Seu documento está em análise.<br />Veja as etapas que faltam:</p>
          </div>
